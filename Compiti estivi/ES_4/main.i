...
void add_question()
{
    ...
    FILE *file_descriptor = fopen("questionario.txt", "a");
    ...
    printf("\nInsert the question (%d letters max): ", 500);
    fgets(question, 500, 
# 91 "main.c" 3
                                    (__acrt_iob_func(0))
# 91 "main.c"
    ...
    {
        char response[100] = {};
        printf("Insert answer %c (%d letters max): ", answer_id, 100);
        fgets(response, 100, 
# 103 "main.c" 3
                                      (__acrt_iob_func(0))
# 103 "main.c"
...
void delete_question()
{
    ...
    FILE *file_descriptor = fopen("questionario.txt", "r");
    check_file(file_descriptor);
    ...
    while (fgets(temp_buffer, 500, file_descriptor))
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            if (!fgets(temp_buffer, 500, file_descriptor))
            {
                break;
            }
        }
    ...
    if (!fgets(input_buf, sizeof(input_buf), 
# 164 "main.c" 3
                                            (__acrt_iob_func(0))
# 164 "main.c"
                                                 )) {
    ...
    to_delete = (int)strtol(input_buf, 
# 169 "main.c" 3
                                      ((void *)0)
# 169 "main.c"
                                          , 10);
    ...
    while (fgets(line, 500, file_descriptor))
    {
        if (current_question == to_delete)
        {
            for (int i = 0; i < 5; i++)
            {
                if (!fgets(line, 500, file_descriptor)) break;
            }
        }
        else
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                if (fgets(line, 500, file_descriptor))
                {
                    fputs(line, temp_file_descriptor);
                }
                else break;
    ...
    rename("temp.txt", "questionario.txt");
    return;
}
...
int give_questionnaire()
{
    ...
    while (fgets(line, 500, file_descriptor))
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            fgets(line, 100, file_descriptor);
            printf("%s", line);
        }
